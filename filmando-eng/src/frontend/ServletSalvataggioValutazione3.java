...
/* Questa servlet, salva le preferenze dell’utente in un file chiamato valutazioni3<timestamp>.txt, 
...
public class ServletSalvataggioValutazione3 extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws UnsupportedEncodingException, IOException {
        ...
        Files.write(Paths.get(Configurazione.path + "filesFilmando2/valutazione3.txt"), output.getBytes(), StandardOpenOption.APPEND);
       
        String url = "pagine/results4.jsp?tempo="+ tempo + "&pref=" + pref0;		//togliere pref
